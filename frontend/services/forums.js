...
const ForumsCategories = [
  {
    ...
    subCategories: [
      {
        id: 46,
        name: 'All Things Averia',
        description:
          'The area for discussions purely about Averia – the features, the games, and company news.',
      },
      {
        id: 14,
      ...
      },
      {
        ...
        description:
          'Do you have a suggestion and ideas for Averia? Share your feedback here.',
      },
      {
        id: 54,
        name: 'BLOXFaires & Averia events',
        description:
          'Check here to see the crazy things Averia is doing. Contest information can be found here. Averia is going to be at various Maker Faires and conferences around the globe. Discuss those events here!',
      },
    ],
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        ...
        description:
          'A fast paced community dedicated to mastering the Limited Trades and Sales market, and divining the subtleties of the Averia Currency Exchange.',
      },
    ],
  },
];
