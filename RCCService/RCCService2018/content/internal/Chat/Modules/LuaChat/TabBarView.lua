...
function TabBarView:render()
	...
	local tabBarViewVisible = self.props.visible
	...
	for index, tab in ipairs(tabs) do
		...
		if FFlagLuaChatShareGameToChatFromChatV2 then
			local props = tabs[index].content.options
			props.frameHeight = self.props.frameHeight
			...
			contents[index] = Roact.createElement(tabs[index].content.component, props)
		end
	end
	...
	return Roact.createElement("Frame", {
		...
		ContentContainer = Roact.createElement("Frame", {
			...
			Content = FFlagLuaChatShareGameToChatFromChatV2 and Roact.createElement("Frame", {
				BackgroundTransparency = 1,
				Size = UDim2.new(1, 0, 1, 0),
			}, contents) or Roact.createElement(tabs[selectedTabIndex].content.component,
