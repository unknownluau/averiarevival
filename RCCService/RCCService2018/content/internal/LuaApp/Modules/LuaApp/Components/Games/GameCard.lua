...
local THUMB_UP_IMAGE = "rbxasset://textures/ui/LuaApp/voteBar/thumbup.png"
...
function GameCard:init()
	...
	self.Event_buttonShortPressed = function()
...
function GameCard:render()
	...
	local friendFooterPlaceId = game.universeId
