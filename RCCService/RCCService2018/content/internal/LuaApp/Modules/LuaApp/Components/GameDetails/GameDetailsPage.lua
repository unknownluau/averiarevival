...
local function AboutTab(props)
	...
	for gameLayoutOrder, entry in ipairs(recommendedGames) do
		recommendedGameCards[entry.universeId .. tostring(entry.isSponsored)] = Roact.createElement(GameCard, {
			entry = entry,
...
local function makeStoreCard(children, index, card)
	children["Card " .. index] = Roact.createElement("Frame", {
...
GameDetailsPage = RoactRodux.UNSTABLE_connect2(
