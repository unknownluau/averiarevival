...
local cancelSearchOnBackButtonPressed = settings():GetFFlag('LuaAppCancelSearchOnBackButtonPressed')
...
function SearchBar:init()
	...
	self.onFocusLost = function(rbx, enterPressed, inputObject)
		...
		elseif cancelSearchOnBackButtonPressed and inputObject == nil then
			cancelSearch()
		end
	end
