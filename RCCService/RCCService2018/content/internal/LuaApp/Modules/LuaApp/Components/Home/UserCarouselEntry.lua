...
local CHAT_ICON = "rbxasset://textures/ui/LuaApp/icons/ic-chat20x20.png"
local VIEW_PROFILE_ICON = "rbxasset://textures/ui/LuaApp/icons/ic-view-details20x20.png"
...
function UserCarouselEntry:createContextualMenu()
	...
	local position = self.props.count
