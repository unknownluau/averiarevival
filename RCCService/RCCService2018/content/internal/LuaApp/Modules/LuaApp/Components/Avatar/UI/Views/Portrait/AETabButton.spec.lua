return function()
	if (settings():GetFFlag("AvatarEditorRoactRewrite")) then
		...
		it("should have an orange background when this tab is selected", function()
		...
		it("should have a white background when this tab is NOT selected", function()
			...
			local tabButton = container:FindFirstChild("AETabButton")
			expect(tabButton.BackgroundColor3).to.equal(Constants.Color.WHITE)
